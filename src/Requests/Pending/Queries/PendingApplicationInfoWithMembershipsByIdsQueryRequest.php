...
class PendingApplicationInfoWithMembershipsByIdsQueryRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['clientIds' => '[String!]!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('query', 'applicationInfoWithMembershipsByIds', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): ApplicationInfoWithMembershipsByIdsQueryResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(ApplicationInfoWithMembershipsByIdsQueryResponse::class, $query))->throw();
