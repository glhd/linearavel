...
class PendingEmojiQueryRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('query', 'emoji', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): EmojiQueryResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(EmojiQueryResponse::class, $query))->throw();
