...
class PendingRoadmapQueryRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('query', 'roadmap', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): RoadmapQueryResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(RoadmapQueryResponse::class, $query))->throw();
