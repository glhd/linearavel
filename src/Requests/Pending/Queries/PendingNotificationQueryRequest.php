...
class PendingNotificationQueryRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('query', 'notification', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): NotificationQueryResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(NotificationQueryResponse::class, $query))->throw();
