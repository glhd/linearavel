...
class PendingOrganizationDomainClaimRequestQueryRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('query', 'organizationDomainClaimRequest', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): OrganizationDomainClaimRequestQueryResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(OrganizationDomainClaimRequestQueryResponse::class, $query))->throw();
