...
class PendingTemplateQueryRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('query', 'template', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): TemplateQueryResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(TemplateQueryResponse::class, $query))->throw();
