...
class PendingRateLimitStatusQueryRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('query', 'rateLimitStatus', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): RateLimitStatusQueryResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(RateLimitStatusQueryResponse::class, $query))->throw();
