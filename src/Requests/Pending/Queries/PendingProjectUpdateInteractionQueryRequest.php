...
class PendingProjectUpdateInteractionQueryRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('query', 'projectUpdateInteraction', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): ProjectUpdateInteractionQueryResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(ProjectUpdateInteractionQueryResponse::class, $query))->throw();
