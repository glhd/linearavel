...
class PendingApplicationInfoByIdsQueryRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['ids' => '[String!]!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('query', 'applicationInfoByIds', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): ApplicationInfoByIdsQueryResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(ApplicationInfoByIdsQueryResponse::class, $query))->throw();
