...
class PendingApplicationInfoQueryRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['clientId' => 'String!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('query', 'applicationInfo', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): ApplicationInfoQueryResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(ApplicationInfoQueryResponse::class, $query))->throw();
