...
{
	protected const DEFAULT_ATTRIBUTES = ['id', 'createdAt', 'updatedAt', 'owner', 'sortOrder', 'archivedAt'];

	protected const ARGUMENT_TYPES = ['id' => 'String!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('query', 'teamMembership', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): TeamMembershipQueryResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(TeamMembershipQueryResponse::class, $query))->throw();
