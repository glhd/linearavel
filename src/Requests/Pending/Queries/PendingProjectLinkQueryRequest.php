...
class PendingProjectLinkQueryRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('query', 'projectLink', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): ProjectLinkQueryResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(ProjectLinkQueryResponse::class, $query))->throw();
