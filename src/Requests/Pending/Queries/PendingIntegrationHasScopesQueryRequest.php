...
class PendingIntegrationHasScopesQueryRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['scopes' => '[String!]!', 'integrationId' => 'String!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('query', 'integrationHasScopes', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): IntegrationHasScopesQueryResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(IntegrationHasScopesQueryResponse::class, $query))->throw();
