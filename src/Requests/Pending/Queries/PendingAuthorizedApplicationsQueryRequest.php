...
class PendingAuthorizedApplicationsQueryRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('query', 'authorizedApplications', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): AuthorizedApplicationsQueryResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(AuthorizedApplicationsQueryResponse::class, $query))->throw();
