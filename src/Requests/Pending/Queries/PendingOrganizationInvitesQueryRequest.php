...
class PendingOrganizationInvitesQueryRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('query', 'organizationInvites', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): OrganizationInvitesQueryResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(OrganizationInvitesQueryResponse::class, $query))->throw();
