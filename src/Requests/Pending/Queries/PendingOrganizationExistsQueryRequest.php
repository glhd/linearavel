...
class PendingOrganizationExistsQueryRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('query', 'organizationExists', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): OrganizationExistsQueryResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(OrganizationExistsQueryResponse::class, $query))->throw();
