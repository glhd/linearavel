...
class PendingAuthenticationSessionsQueryRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('query', 'authenticationSessions', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): AuthenticationSessionsQueryResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(AuthenticationSessionsQueryResponse::class, $query))->throw();
