...
class PendingTemplatesForIntegrationQueryRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('query', 'templatesForIntegration', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): TemplatesForIntegrationQueryResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(TemplatesForIntegrationQueryResponse::class, $query))->throw();
