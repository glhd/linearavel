...
class PendingExternalUsersQueryRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('query', 'externalUsers', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): ExternalUsersQueryResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(ExternalUsersQueryResponse::class, $query))->throw();
