...
class PendingNotificationsQueryRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('query', 'notifications', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): NotificationsQueryResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(NotificationsQueryResponse::class, $query))->throw();
