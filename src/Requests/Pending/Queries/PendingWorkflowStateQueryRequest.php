...
class PendingWorkflowStateQueryRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('query', 'workflowState', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): WorkflowStateQueryResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(WorkflowStateQueryResponse::class, $query))->throw();
