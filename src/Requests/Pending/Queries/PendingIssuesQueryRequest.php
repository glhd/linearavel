...
class PendingIssuesQueryRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['filter' => 'IssueFilter', 'before' => 'String', 'after' => 'String', 'first' => 'Int', 'last' => 'Int', 'includeArchived' => 'Boolean', 'orderBy' => 'PaginationOrderBy', 'sort' => '[IssueSortInput!]'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('query', 'issues', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): IssuesQueryResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(IssuesQueryResponse::class, $query))->throw();
