...
class PendingRoadmapToProjectQueryRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('query', 'roadmapToProject', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): RoadmapToProjectQueryResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(RoadmapToProjectQueryResponse::class, $query))->throw();
