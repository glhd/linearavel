...
class PendingInitiativeToProjectsQueryRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('query', 'initiativeToProjects', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): InitiativeToProjectsQueryResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(InitiativeToProjectsQueryResponse::class, $query))->throw();
