...
class PendingAuditEntryTypesQueryRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('query', 'auditEntryTypes', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): AuditEntryTypesQueryResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(AuditEntryTypesQueryResponse::class, $query))->throw();
