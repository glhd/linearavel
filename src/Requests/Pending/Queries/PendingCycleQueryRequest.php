...
class PendingCycleQueryRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('query', 'cycle', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): CycleQueryResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(CycleQueryResponse::class, $query))->throw();
