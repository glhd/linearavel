...
class PendingDocumentQueryRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('query', 'document', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): DocumentQueryResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(DocumentQueryResponse::class, $query))->throw();
