...
class PendingAttachmentIssueQueryRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('query', 'attachmentIssue', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): AttachmentIssueQueryResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(AttachmentIssueQueryResponse::class, $query))->throw();
