...
class PendingWorkspaceAuthorizedApplicationsQueryRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('query', 'workspaceAuthorizedApplications', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): WorkspaceAuthorizedApplicationsQueryResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(WorkspaceAuthorizedApplicationsQueryResponse::class, $query))->throw();
