...
class PendingCustomViewDetailsSuggestionQueryRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['modelName' => 'String', 'filter' => 'JSONObject!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('query', 'customViewDetailsSuggestion', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): CustomViewDetailsSuggestionQueryResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(CustomViewDetailsSuggestionQueryResponse::class, $query))->throw();
