...
class PendingWorkflowStatesQueryRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['filter' => 'WorkflowStateFilter', 'before' => 'String', 'after' => 'String', 'first' => 'Int', 'last' => 'Int', 'includeArchived' => 'Boolean', 'orderBy' => 'PaginationOrderBy'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('query', 'workflowStates', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): WorkflowStatesQueryResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(WorkflowStatesQueryResponse::class, $query))->throw();
