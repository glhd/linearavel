...
class PendingTemplatesQueryRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('query', 'templates', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): TemplatesQueryResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(TemplatesQueryResponse::class, $query))->throw();
