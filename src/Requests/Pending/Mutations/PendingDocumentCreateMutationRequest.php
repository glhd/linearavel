...
class PendingDocumentCreateMutationRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['input' => 'DocumentCreateInput!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'documentCreate', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): DocumentCreateMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(DocumentCreateMutationResponse::class, $query))->throw();
