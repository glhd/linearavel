...
class PendingIntegrationGithubCommitCreateMutationRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'integrationGithubCommitCreate', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): IntegrationGithubCommitCreateMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(IntegrationGithubCommitCreateMutationResponse::class, $query))->throw();
