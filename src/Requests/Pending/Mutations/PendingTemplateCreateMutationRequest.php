...
class PendingTemplateCreateMutationRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['input' => 'TemplateCreateInput!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'templateCreate', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): TemplateCreateMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(TemplateCreateMutationResponse::class, $query))->throw();
