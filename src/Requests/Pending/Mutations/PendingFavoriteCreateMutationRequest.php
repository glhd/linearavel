...
class PendingFavoriteCreateMutationRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['input' => 'FavoriteCreateInput!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'favoriteCreate', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): FavoriteCreateMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(FavoriteCreateMutationResponse::class, $query))->throw();
