...
class PendingOrganizationCancelDeleteMutationRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'organizationCancelDelete', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): OrganizationCancelDeleteMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(OrganizationCancelDeleteMutationResponse::class, $query))->throw();
