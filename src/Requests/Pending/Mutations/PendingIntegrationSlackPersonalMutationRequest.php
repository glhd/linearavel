...
class PendingIntegrationSlackPersonalMutationRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'integrationSlackPersonal', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): IntegrationSlackPersonalMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(IntegrationSlackPersonalMutationResponse::class, $query))->throw();
