...
class PendingOrganizationDeleteMutationRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['input' => 'DeleteOrganizationInput!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'organizationDelete', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): OrganizationDeleteMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(OrganizationDeleteMutationResponse::class, $query))->throw();
