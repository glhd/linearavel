...
class PendingGitAutomationTargetBranchUpdateMutationRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['input' => 'GitAutomationTargetBranchUpdateInput!', 'id' => 'String!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'gitAutomationTargetBranchUpdate', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): GitAutomationTargetBranchUpdateMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(GitAutomationTargetBranchUpdateMutationResponse::class, $query))->throw();
