...
class PendingFileUploadMutationRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['metaData' => 'JSON', 'makePublic' => 'Boolean', 'size' => 'Int!', 'contentType' => 'String!', 'filename' => 'String!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'fileUpload', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): FileUploadMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(FileUploadMutationResponse::class, $query))->throw();
