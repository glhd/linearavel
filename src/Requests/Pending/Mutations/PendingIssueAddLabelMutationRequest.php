...
class PendingIssueAddLabelMutationRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'issueAddLabel', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): IssueAddLabelMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(IssueAddLabelMutationResponse::class, $query))->throw();
