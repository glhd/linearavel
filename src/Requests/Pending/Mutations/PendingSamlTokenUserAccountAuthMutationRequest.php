...
class PendingSamlTokenUserAccountAuthMutationRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'samlTokenUserAccountAuth', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): SamlTokenUserAccountAuthMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(SamlTokenUserAccountAuthMutationResponse::class, $query))->throw();
