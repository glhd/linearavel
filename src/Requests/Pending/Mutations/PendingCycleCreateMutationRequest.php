...
class PendingCycleCreateMutationRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['input' => 'CycleCreateInput!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'cycleCreate', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): CycleCreateMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(CycleCreateMutationResponse::class, $query))->throw();
