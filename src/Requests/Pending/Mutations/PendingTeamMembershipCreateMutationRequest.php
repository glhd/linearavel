...
class PendingTeamMembershipCreateMutationRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['input' => 'TeamMembershipCreateInput!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'teamMembershipCreate', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): TeamMembershipCreateMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(TeamMembershipCreateMutationResponse::class, $query))->throw();
