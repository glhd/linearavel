...
class PendingProjectUpdateMutationRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['input' => 'ProjectUpdateInput!', 'id' => 'String!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'projectUpdate', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): ProjectUpdateMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(ProjectUpdateMutationResponse::class, $query))->throw();
