...
class PendingIntegrationGoogleSheetsMutationRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'integrationGoogleSheets', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): IntegrationGoogleSheetsMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(IntegrationGoogleSheetsMutationResponse::class, $query))->throw();
