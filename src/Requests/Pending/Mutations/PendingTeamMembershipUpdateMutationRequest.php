...
class PendingTeamMembershipUpdateMutationRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['input' => 'TeamMembershipUpdateInput!', 'id' => 'String!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'teamMembershipUpdate', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): TeamMembershipUpdateMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(TeamMembershipUpdateMutationResponse::class, $query))->throw();
