...
class PendingOrganizationStartPlusTrialMutationRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'organizationStartPlusTrial', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): OrganizationStartPlusTrialMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(OrganizationStartPlusTrialMutationResponse::class, $query))->throw();
