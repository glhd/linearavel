...
class PendingTeamMembershipDeleteMutationRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['alsoLeaveParentTeams' => 'Boolean', 'id' => 'String!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'teamMembershipDelete', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): TeamMembershipDeleteMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(TeamMembershipDeleteMutationResponse::class, $query))->throw();
