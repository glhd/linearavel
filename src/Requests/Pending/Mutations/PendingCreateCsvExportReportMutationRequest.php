...
class PendingCreateCsvExportReportMutationRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'createCsvExportReport', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): CreateCsvExportReportMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(CreateCsvExportReportMutationResponse::class, $query))->throw();
