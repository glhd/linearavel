...
class PendingIntegrationSlackPostMutationRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['shouldUseV2Auth' => 'Boolean', 'redirectUri' => 'String!', 'teamId' => 'String!', 'code' => 'String!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'integrationSlackPost', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): IntegrationSlackPostMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(IntegrationSlackPostMutationResponse::class, $query))->throw();
