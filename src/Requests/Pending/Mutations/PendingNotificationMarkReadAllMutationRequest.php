...
class PendingNotificationMarkReadAllMutationRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['readAt' => 'DateTime!', 'input' => 'NotificationEntityInput!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'notificationMarkReadAll', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): NotificationMarkReadAllMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(NotificationMarkReadAllMutationResponse::class, $query))->throw();
