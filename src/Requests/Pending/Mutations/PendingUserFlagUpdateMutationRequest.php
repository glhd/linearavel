...
class PendingUserFlagUpdateMutationRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'userFlagUpdate', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): UserFlagUpdateMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(UserFlagUpdateMutationResponse::class, $query))->throw();
