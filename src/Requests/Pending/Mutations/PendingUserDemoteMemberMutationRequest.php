...
class PendingUserDemoteMemberMutationRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'userDemoteMember', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): UserDemoteMemberMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(UserDemoteMemberMutationResponse::class, $query))->throw();
