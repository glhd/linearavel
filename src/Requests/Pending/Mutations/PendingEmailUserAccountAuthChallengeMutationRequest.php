...
class PendingEmailUserAccountAuthChallengeMutationRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['input' => 'EmailUserAccountAuthChallengeInput!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'emailUserAccountAuthChallenge', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): EmailUserAccountAuthChallengeMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(EmailUserAccountAuthChallengeMutationResponse::class, $query))->throw();
