...
class PendingIntegrationSlackMutationRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['requestedScopes' => '[String!]', 'shouldUseV2Auth' => 'Boolean', 'redirectUri' => 'String!', 'code' => 'String!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'integrationSlack', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): IntegrationSlackMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(IntegrationSlackMutationResponse::class, $query))->throw();
