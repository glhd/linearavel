...
class PendingIssueRelationCreateMutationRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'issueRelationCreate', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): IssueRelationCreateMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(IssueRelationCreateMutationResponse::class, $query))->throw();
