...
class PendingIntegrationLoomMutationRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'integrationLoom', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): IntegrationLoomMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(IntegrationLoomMutationResponse::class, $query))->throw();
