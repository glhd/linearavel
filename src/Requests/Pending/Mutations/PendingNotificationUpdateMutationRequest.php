...
class PendingNotificationUpdateMutationRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['input' => 'NotificationUpdateInput!', 'id' => 'String!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'notificationUpdate', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): NotificationUpdateMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(NotificationUpdateMutationResponse::class, $query))->throw();
