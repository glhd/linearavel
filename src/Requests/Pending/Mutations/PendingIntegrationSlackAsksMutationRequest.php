...
class PendingIntegrationSlackAsksMutationRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'integrationSlackAsks', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): IntegrationSlackAsksMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(IntegrationSlackAsksMutationResponse::class, $query))->throw();
