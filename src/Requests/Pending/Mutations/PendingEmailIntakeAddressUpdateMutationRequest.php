...
class PendingEmailIntakeAddressUpdateMutationRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['input' => 'EmailIntakeAddressUpdateInput!', 'id' => 'String!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'emailIntakeAddressUpdate', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): EmailIntakeAddressUpdateMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(EmailIntakeAddressUpdateMutationResponse::class, $query))->throw();
