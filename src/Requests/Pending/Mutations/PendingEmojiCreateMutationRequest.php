...
class PendingEmojiCreateMutationRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['input' => 'EmojiCreateInput!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'emojiCreate', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): EmojiCreateMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(EmojiCreateMutationResponse::class, $query))->throw();
