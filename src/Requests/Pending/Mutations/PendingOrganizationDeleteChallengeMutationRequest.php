...
class PendingOrganizationDeleteChallengeMutationRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'organizationDeleteChallenge', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): OrganizationDeleteChallengeMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(OrganizationDeleteChallengeMutationResponse::class, $query))->throw();
