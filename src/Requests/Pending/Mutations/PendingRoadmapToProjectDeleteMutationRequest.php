...
class PendingRoadmapToProjectDeleteMutationRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'roadmapToProjectDelete', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): RoadmapToProjectDeleteMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(RoadmapToProjectDeleteMutationResponse::class, $query))->throw();
