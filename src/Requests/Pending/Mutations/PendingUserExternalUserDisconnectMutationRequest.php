...
class PendingUserExternalUserDisconnectMutationRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'userExternalUserDisconnect', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): UserExternalUserDisconnectMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(UserExternalUserDisconnectMutationResponse::class, $query))->throw();
