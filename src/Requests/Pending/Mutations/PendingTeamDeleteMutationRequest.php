...
class PendingTeamDeleteMutationRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'teamDelete', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): TeamDeleteMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(TeamDeleteMutationResponse::class, $query))->throw();
