...
class PendingApiKeyCreateMutationRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['input' => 'ApiKeyCreateInput!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'apiKeyCreate', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): ApiKeyCreateMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(ApiKeyCreateMutationResponse::class, $query))->throw();
