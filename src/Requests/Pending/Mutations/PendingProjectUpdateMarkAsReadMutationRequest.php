...
class PendingProjectUpdateMarkAsReadMutationRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'projectUpdateMarkAsRead', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): ProjectUpdateMarkAsReadMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(ProjectUpdateMarkAsReadMutationResponse::class, $query))->throw();
