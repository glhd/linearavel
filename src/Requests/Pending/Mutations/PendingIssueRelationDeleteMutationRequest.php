...
class PendingIssueRelationDeleteMutationRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'issueRelationDelete', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): IssueRelationDeleteMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(IssueRelationDeleteMutationResponse::class, $query))->throw();
