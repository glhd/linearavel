...
class PendingNotificationSubscriptionUpdateMutationRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['input' => 'NotificationSubscriptionUpdateInput!', 'id' => 'String!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'notificationSubscriptionUpdate', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): NotificationSubscriptionUpdateMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(NotificationSubscriptionUpdateMutationResponse::class, $query))->throw();
