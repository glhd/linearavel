...
class PendingTimeScheduleUpsertExternalMutationRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['input' => 'TimeScheduleUpdateInput!', 'externalId' => 'String!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'timeScheduleUpsertExternal', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): TimeScheduleUpsertExternalMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(TimeScheduleUpsertExternalMutationResponse::class, $query))->throw();
