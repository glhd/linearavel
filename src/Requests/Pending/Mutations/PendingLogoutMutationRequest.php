...
class PendingLogoutMutationRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'logout', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): LogoutMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(LogoutMutationResponse::class, $query))->throw();
