...
class PendingContactSalesCreateMutationRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['input' => 'ContactSalesCreateInput!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'contactSalesCreate', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): ContactSalesCreateMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(ContactSalesCreateMutationResponse::class, $query))->throw();
