...
class PendingProjectLinkCreateMutationRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['input' => 'ProjectLinkCreateInput!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'projectLinkCreate', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): ProjectLinkCreateMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(ProjectLinkCreateMutationResponse::class, $query))->throw();
