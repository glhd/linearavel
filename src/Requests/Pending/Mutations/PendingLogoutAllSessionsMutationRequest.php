...
class PendingLogoutAllSessionsMutationRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'logoutAllSessions', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): LogoutAllSessionsMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(LogoutAllSessionsMutationResponse::class, $query))->throw();
