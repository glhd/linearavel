...
class PendingEmailUnsubscribeMutationRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['input' => 'EmailUnsubscribeInput!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'emailUnsubscribe', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): EmailUnsubscribeMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(EmailUnsubscribeMutationResponse::class, $query))->throw();
