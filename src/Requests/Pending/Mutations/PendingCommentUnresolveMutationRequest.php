...
class PendingCommentUnresolveMutationRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'commentUnresolve', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): CommentUnresolveMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(CommentUnresolveMutationResponse::class, $query))->throw();
