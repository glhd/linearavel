...
class PendingGoogleUserAccountAuthMutationRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['input' => 'GoogleUserAccountAuthInput!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'googleUserAccountAuth', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): GoogleUserAccountAuthMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(GoogleUserAccountAuthMutationResponse::class, $query))->throw();
