...
class PendingNotificationMarkUnreadAllMutationRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'notificationMarkUnreadAll', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): NotificationMarkUnreadAllMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(NotificationMarkUnreadAllMutationResponse::class, $query))->throw();
