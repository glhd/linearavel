...
class PendingProjectDeleteMutationRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'projectDelete', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): ProjectDeleteMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(ProjectDeleteMutationResponse::class, $query))->throw();
