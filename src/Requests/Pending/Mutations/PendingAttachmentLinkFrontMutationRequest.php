...
class PendingAttachmentLinkFrontMutationRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['createAsUser' => 'String', 'displayIconUrl' => 'String', 'title' => 'String', 'conversationId' => 'String!', 'issueId' => 'String!', 'id' => 'String'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'attachmentLinkFront', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): AttachmentLinkFrontMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(AttachmentLinkFrontMutationResponse::class, $query))->throw();
