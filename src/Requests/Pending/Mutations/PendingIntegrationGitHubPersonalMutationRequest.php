...
class PendingIntegrationGitHubPersonalMutationRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'integrationGitHubPersonal', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): IntegrationGitHubPersonalMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(IntegrationGitHubPersonalMutationResponse::class, $query))->throw();
