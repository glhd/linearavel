...
class PendingCommentCreateMutationRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['input' => 'CommentCreateInput!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'commentCreate', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): CommentCreateMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(CommentCreateMutationResponse::class, $query))->throw();
