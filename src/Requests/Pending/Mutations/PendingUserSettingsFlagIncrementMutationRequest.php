...
class PendingUserSettingsFlagIncrementMutationRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['flag' => 'String!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'userSettingsFlagIncrement', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): UserSettingsFlagIncrementMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(UserSettingsFlagIncrementMutationResponse::class, $query))->throw();
