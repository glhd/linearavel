...
class PendingTimeScheduleCreateMutationRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['input' => 'TimeScheduleCreateInput!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'timeScheduleCreate', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): TimeScheduleCreateMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(TimeScheduleCreateMutationResponse::class, $query))->throw();
