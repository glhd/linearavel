...
class PendingTimeScheduleDeleteMutationRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'timeScheduleDelete', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): TimeScheduleDeleteMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(TimeScheduleDeleteMutationResponse::class, $query))->throw();
