...
class PendingAirbyteIntegrationConnectMutationRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['input' => 'AirbyteConfigurationInput!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'airbyteIntegrationConnect', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): AirbyteIntegrationConnectMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(AirbyteIntegrationConnectMutationResponse::class, $query))->throw();
