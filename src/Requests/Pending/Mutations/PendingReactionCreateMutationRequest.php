...
class PendingReactionCreateMutationRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['input' => 'ReactionCreateInput!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'reactionCreate', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): ReactionCreateMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(ReactionCreateMutationResponse::class, $query))->throw();
