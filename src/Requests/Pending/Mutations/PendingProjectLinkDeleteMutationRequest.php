...
class PendingProjectLinkDeleteMutationRequest extends PendingLinearRequest
{
	...
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'projectLinkDelete', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): ProjectLinkDeleteMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(ProjectLinkDeleteMutationResponse::class, $query))->throw();
