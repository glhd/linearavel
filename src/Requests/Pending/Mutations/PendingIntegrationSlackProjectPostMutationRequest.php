...
class PendingIntegrationSlackProjectPostMutationRequest extends PendingLinearRequest
{
	...
	protected const ARGUMENT_TYPES = ['service' => 'String!', 'redirectUri' => 'String!', 'projectId' => 'String!', 'code' => 'String!'];

	public function __construct(LinearConnector $connector, public array $args = [])
	{
		parent::__construct($connector, GraphQueryBuilder::make('mutation', 'integrationSlackProjectPost', $args, static::ARGUMENT_TYPES));
	}
	...
	public function response(string ...$fields): IntegrationSlackProjectPostMutationResponse
	{
		...
		$response = $this->connector->send(new LinearRequest(IntegrationSlackProjectPostMutationResponse::class, $query))->throw();
