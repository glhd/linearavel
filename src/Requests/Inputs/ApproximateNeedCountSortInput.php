...
/** @see https://studio.apollographql.com/public/Linear-API/variant/current/schema/reference/inputs/ApproximateNeedCountSort */
class ApproximateNeedCountSortInput
{
