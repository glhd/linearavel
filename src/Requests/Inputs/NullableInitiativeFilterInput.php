...
/** @see https://studio.apollographql.com/public/Linear-API/variant/current/schema/reference/inputs/NullableInitiativeFilter */
class NullableInitiativeFilterInput
{
	public function __construct(
		...
		/** @var iterable<NullableInitiativeFilterInput>|Collection<int, NullableInitiativeFilterInput> */
