...
/** @see https://studio.apollographql.com/public/Linear-API/variant/current/schema/reference/inputs/CustomViewUpdatedAtSort */
class CustomViewUpdatedAtSortInput
{
