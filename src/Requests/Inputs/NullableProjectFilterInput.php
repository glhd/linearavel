...
/** @see https://studio.apollographql.com/public/Linear-API/variant/current/schema/reference/inputs/NullableProjectFilter */
class NullableProjectFilterInput
{
	public function __construct(
		...
		/** @var iterable<NullableProjectFilterInput>|Collection<int, NullableProjectFilterInput> */
