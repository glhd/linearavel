...
/** @see https://studio.apollographql.com/public/Linear-API/variant/current/schema/reference/inputs/CustomerImportantCountSort */
class CustomerImportantCountSortInput
{
