...
{
	public function __construct(public string $channel, public string $channelId, public string $configurationUrl, public ?string $teamId = null, public ?SlackChannelType $channelType = null)
	{
	}
}
