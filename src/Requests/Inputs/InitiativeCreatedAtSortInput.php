...
/** @see https://studio.apollographql.com/public/Linear-API/variant/current/schema/reference/inputs/InitiativeCreatedAtSort */
class InitiativeCreatedAtSortInput
{
