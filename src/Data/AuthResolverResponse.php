...
/** @see https://studio.apollographql.com/public/Linear-API/variant/current/schema/reference/objects/AuthResolverResponse */
class AuthResolverResponse extends Data
{
	public function __construct(
		...
		/** @var Collection<int, AuthUser> */
		public Optional|Collection $lockedUsers,
