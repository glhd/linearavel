...
/** @see https://studio.apollographql.com/public/Linear-API/variant/current/schema/reference/objects/WorkspaceAnnouncementNotification */
class WorkspaceAnnouncementNotification extends Data implements Notification, Entity, Node
{
	public function __construct(
		...
		public Optional|string $workspaceAnnouncementId,
		#[LinearDate]
