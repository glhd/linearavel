...
class OauthClientApprovalNotification extends Data implements Notification, Entity, Node
{
	public function __construct(
		...
		#[LinearDate] public Optional|CarbonImmutable|null $readAt,
		#[LinearDate] public Optional|CarbonImmutable|null $emailedAt,
		#[LinearDate] public Optional|CarbonImmutable|null $snoozedUntilAt,
		#[LinearDate] public Optional|CarbonImmutable|null $unsnoozedAt,
