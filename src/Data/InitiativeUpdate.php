...
/** @see https://studio.apollographql.com/public/Linear-API/variant/current/schema/reference/objects/InitiativeUpdate */
class InitiativeUpdate extends Data implements Node
{
	public function __construct(
		...
		public Optional|InitiativeUpdateHealthType $health,
