...
/** @see https://studio.apollographql.com/public/Linear-API/variant/current/schema/reference/objects/WelcomeMessageNotification */
class WelcomeMessageNotification extends Data implements Notification, Entity, Node
{
	public function __construct(
		...
		public Optional|string $welcomeMessageId,
		#[LinearDate]
