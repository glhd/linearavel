...
/** @see https://studio.apollographql.com/public/Linear-API/variant/current/schema/reference/objects/ProductAnnouncementNotification */
class ProductAnnouncementNotification extends Data implements Notification, Entity, Node
{
	public function __construct(
		...
		public Optional|string $productAnnouncementId,
		public Optional|ProductAnnouncement $productAnnouncement,
		#[LinearDate]
