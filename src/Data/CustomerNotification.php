...
/** @see https://studio.apollographql.com/public/Linear-API/variant/current/schema/reference/objects/CustomerNotification */
class CustomerNotification extends Data implements Notification, Entity, Node
{
