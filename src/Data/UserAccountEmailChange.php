...
class UserAccountEmailChange extends Data
{
	function __construct(
		...
		#[WithCast(DateTimeInterfaceCast::class, DateTimeInterface::RFC3339_EXTENDED)] public Optional|CarbonImmutable|null $oldEmailVerifiedAt = null,
		public Optional|string $newEmail,
		#[WithCast(DateTimeInterfaceCast::class, DateTimeInterface::RFC3339_EXTENDED)] public Optional|CarbonImmutable|null $newEmailVerifiedAt = null,
