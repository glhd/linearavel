...
/** @see https://studio.apollographql.com/public/Linear-API/variant/current/schema/reference/objects/DocumentNotification */
class DocumentNotification extends Data implements Notification, Entity, Node
{
