...
/** @see https://studio.apollographql.com/public/Linear-API/variant/current/schema/reference/objects/WorkflowDefinitionNotification */
class WorkflowDefinitionNotification extends Data implements Notification, Entity, Node
{
	public function __construct(
		...
		public Optional|string $workflowDefinitionId,
		public Optional|WorkflowDefinition $workflowDefinition,
		#[LinearDate]
		...
		public Optional|string|null $aiConversationId
	) {
	}
}
