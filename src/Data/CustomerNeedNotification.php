...
/** @see https://studio.apollographql.com/public/Linear-API/variant/current/schema/reference/objects/CustomerNeedNotification */
class CustomerNeedNotification extends Data implements Notification, Entity, Node
{
	public function __construct(
		...
		public Optional|string $customerNeedId,
		public Optional|CustomerNeed $customerNeed,
		#[LinearDate]
		...
		public Optional|Issue|null $relatedIssue,
		public Optional|Project|null $relatedProject
	) {
	}
}
