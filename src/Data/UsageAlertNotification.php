...
/** @see https://studio.apollographql.com/public/Linear-API/variant/current/schema/reference/objects/UsageAlertNotification */
class UsageAlertNotification extends Data implements Notification, Entity, Node
{
	public function __construct(
		...
		public Optional|string $usageAlertId,
		public Optional|UsageAlert $usageAlert,
		#[LinearDate]
